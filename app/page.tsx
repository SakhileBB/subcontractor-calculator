...
const exportToPDF = async (
  ...
  doc.text(
    "Note: The R3000 management fee has been subtracted from the profit share.",
    10,
    y
  );
...
export default function SubcontractorCalculator() {
  ...
  const cleanNumber = (val: string | number): string =>
  ...
  const calculate = () => {
    ...
    const amountOwed =
      subcontractorProfitShare - MANAGEMENT_FEE + subcontractorExpenseShare;
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", background: "#fff", padding: "2rem", borderRadius: "10px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
        ...
        <label style={{ fontWeight: "bold" }}>
          ...
          <input
            ...
            style={{ width: "100%", padding: "8px", marginTop: "0.3rem", marginBottom: "1rem" }}
          />
        </label>
        ...
        <div style={{ display: "flex", gap: "1rem", marginBottom: "1rem" }}>
          <label style={{ flex: 1, fontWeight: "bold" }}>
            ...
            <input
              ...
              style={{ width: "100%", padding: "8px", marginTop: "0.3rem" }}
            />
          </label>
          <label style={{ flex: 1, fontWeight: "bold" }}>
            End Date
        ...
        {[["Income", income, setIncome],
          ...
          ["Cleaning Supplies", cleaningSupplies, setCleaningSupplies]].map(([label, value, setter], i) => (
        ...
        <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1rem" }}>
          ...
          <button onClick={() => {
            ...
            setNewExpenseName("");
            setNewExpenseAmount("");
          }} style={{ backgroundColor: "#0e4d92", color: "#fff", padding: "10px 16px", borderRadius: "5px", border: "none", cursor: "pointer" }}>
            Add
          </button>
        </div>
